export function Hero() {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary-500 via-primary-600 to-secondary-600 p-8 md:p-12">
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-secondary-500/20 to-transparent rounded-full translate-y-48 -translate-x-48" />
      
      {/* Tech stack badges */}
      <div className="mt-12 flex flex-wrap gap-3">
        {['React', 'TypeScript', 'Next.js', 'Node.js', 'AWS', 'Docker', 'Kubernetes', 'PostgreSQL'].map((tech) => (
          <span
            key={tech}
